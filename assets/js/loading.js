...
document.addEventListener("DOMContentLoaded", function(event) {
  var phrases = shuffleArray(["Médicos de renombre", "Tus especialistas siempre para ti", "Doctorfy te cuida", "Tus médicos de confianza", "Los mas recomendados", "Médicos de renombre", "Tus especialistas siempre para ti", "100% de confianza", "Tus médicos de confianza", "Tus especialistas siempre para ti", "Subespecialistas"]);
